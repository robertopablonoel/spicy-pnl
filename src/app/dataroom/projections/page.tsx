...
import { ProjectionsSlide1 } from '@/components/projections/ProjectionsSlide1';
import { ProjectionsSlide2 } from '@/components/projections/ProjectionsSlide2';
import { ProjectionsSlide3 } from '@/components/projections/ProjectionsSlide3';
import { ProjectionsSlide4 } from '@/components/projections/ProjectionsSlide4';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
      ...
      <div className="absolute top-4 left-4 md:top-6 md:left-6 z-10">
        ...
        >
          ...
          <span className="text-sm font-medium hidden sm:inline">Data Room</span>
        </Link>
      </div>
